...
// Interação com o usuário
        ...
        printf("DEFINA O TAMANHO DA MATRIZ B\n\n");
        printf("DIGITE O NUMERO DE LINHAS (MAX 10): ");
        scanf("%d", & linha_B);
        printf("DIGITE O NUMERO DE COLUNAS (MAX 10): ");
        scanf("%d", & coluna_B);
...
// Função para preencher a matriz A com valores aleatórios
...
// Verifica se a matriz possui um tamanho definido pelo usuário
...
// Informa que a matriz será 10x10 pois seu tamanho não foi definido

        printf("A MATRIZ FOI PREENCHIDA DE MANEIRA PADRAO 10x10\n");
...
// Sinaliza que a matriz possui valores
...
// Principal
        ...
        printf("(12) IMPRIMIR MATRIZ RESULTADO\n");
        printf("(13) SAIR\n\n");
        printf("SUA ESCOLHA: ");
        scanf("%d", & escolha);
        printf("------------------------------------------\n");
